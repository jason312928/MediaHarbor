...
enum L10n {
    ...
    private static let english: [String: String] = [
        ...
        "subtitle_format": "Subtitle format", "original_best": "Original / best", "subtitle_options": "Subtitle options",
        "available_languages": "%d available languages", "all_languages": "All languages", "subtitle_languages": "Subtitle languages",
        "subtitle_files_only": "SRT, VTT or ASS · subtitles only", "popular_sites": "Popular supported sites",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "download_subtitles": "保留独立字幕文件", "automatic_subtitles": "包含自动生成字幕", "subtitle_format": "字幕格式", "original_best": "原始 / 最佳格式",
        "subtitle_options": "字幕选项", "available_languages": "%d 种可用语言", "all_languages": "全部语言", "subtitle_languages": "字幕语言",
        "subtitle_files_only": "SRT、VTT 或 ASS · 仅字幕", "popular_sites": "常用支持网站",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "download_subtitles": "保留獨立字幕檔案", "automatic_subtitles": "包含自動產生字幕", "subtitle_format": "字幕格式", "original_best": "原始 / 最佳格式",
        "subtitle_options": "字幕選項", "available_languages": "%d 種可用語言", "all_languages": "全部語言", "subtitle_languages": "字幕語言",
        "subtitle_files_only": "SRT、VTT 或 ASS · 僅字幕", "popular_sites": "常用支援網站",
    ...
    private static let japanese: [String: String] = [
        ...
        "download_subtitles": "字幕ファイルを保存", "automatic_subtitles": "自動生成字幕を含める", "subtitle_format": "字幕形式", "original_best": "オリジナル / 最適",
        "subtitle_options": "字幕オプション", "available_languages": "%d 言語が利用可能", "all_languages": "すべての言語", "subtitle_languages": "字幕言語",
        "subtitle_files_only": "SRT、VTT、ASS · 字幕のみ", "popular_sites": "主な対応サイト",
